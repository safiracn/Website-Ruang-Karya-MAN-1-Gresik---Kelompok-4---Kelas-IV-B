...
<table>
    <thead>
       <tr>
            ...
            <th style="width:13%">Pembeli</th>
            <th style="width:13%">Penerima</th>
            <th style="width:8%">Kota</th>
            <th style="width:7%">Metode Pengiriman</th>
            <th style="width:10%">Status Pembayaran</th>
            <th style="width:12%">Status Pesanan</th>
    ...
    <tbody>
        ...
        @php
            $kodePesanan = 'RK' . str_pad($p->id_pembelian, 5, '0', STR_PAD_LEFT);
        ...
        @endforeach
        <tr class="total-row">
            <td colspan="10" style="text-align:right; padding-right:12px;">TOTAL PENDAPATAN (LUNAS)</td>
